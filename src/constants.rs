...
// Base
pub static BODY_EATERS_N: usize = 1200;
...
pub static AVERAGE_ENERGY: f32 = 9000.0;
...
pub static COLOR_GAP: f32 = 0.6; // Depends on COLOR_MIN and COLOR_MAX
...
pub static ENERGY_SPEND_CONST_FOR_VISION: f32 = 0.001;
